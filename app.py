...
app.config['MYSQL_USER'] = 'hello_php'
app.config['MYSQL_PASSWORD'] = '$Tnh210302'
...
def index():
    ...
    #Get message
    values = 'book'
    cur.execute("SELECT * FROM products WHERE category=%s ORDER BY RAND()", (values,))
    book = cur.fetchall()
    ...
    return render_template('home.html', book=book, form=form)
